...
*Note that if you change the TT mode, sometimes the Eclipse Times will yield different results. The delta t calculation is based out of the tt mode select
